*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMJE_UPL_CTRL_V
*   generation date: 17.11.2021 at 22:36:07
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMJE_UPL_CTRL_V     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMJE_UPL_CTRL_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMJE_UPL_CTRL_V_EXTRACT
TOTAL = ZMJE_UPL_CTRL_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMJE_UPL_CTRL_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMJE_UPL_CTRL_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMJE_UPL_CTRL_V_EXTRACT
TOTAL = ZMJE_UPL_CTRL_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMJE_UPL_CTRL_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMJE_UPL_CTRL_V'
...
TOTAL = ZMJE_UPL_CTRL_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMJE_UPL_CTRL_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMJE_UPL_CTRL_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMJE_UPL_CTRL_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMJE_UPL_CTRL_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMJE_UPL_CTRL_V_EXTRACT
TOTAL = ZMJE_UPL_CTRL_V_TOTAL
